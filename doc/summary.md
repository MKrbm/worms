...
- FF_1D model (commit : 10a2a27336ffb000cff4d06e2e7588984e449c3b)
  ...
  - seed = 0
    ...
    - lt = 2 # this means we bundle two sites as a unit cell.
      ...
      - Calculate with exact diagonalization. -lt : 2 0,
        1.24999478076359048724650389167005994993416419062970401654411e-15 1,
        0.000561178521508898090798533875300790896289981901645660400390625

        -lt : 1 0,
        3.73130874259994730714993376783848928992458712132831988306236e-16 1,
        0.0005611785215093203875447169792778367991559207439422607421875
  ...
  - FF2D
    ...
    - PEPS is completely symmetric i.e. A*{ijklp} = A*{kjilp} = A*{ikljp} =
      A*{jklip} = ..
    - only sps higher than 7 had non-zero kernel

    - sps = 8
    - loss u :
      "../python/rmsKit/array/torch/FF2D_loc/s_8_r_2_lt_1_d_2_seed_0/1_mel_Adam/lr_0.001_epoch_4000/loss_0.78790/u"
