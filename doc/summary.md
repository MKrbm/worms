...
- FF_1D model (commit : 10a2a27336ffb000cff4d06e2e7588984e449c3b)
  ...
  - seed = 0
    ...
    - lt = 2 # this means we bundle two sites as a unit cell.

      | T | exact | mes  | 
      | --- | ---- | ----|
      | 1 | 0.5023736820605401 | 0.50255 +- 0.000980229 |
      | 0.5 | 0.2132496963707793 | 0.2124 +- 0.000841817 | 

      Average sign

      | T    | mel (lt = 2)                        | mel (lt = 1)                      |
      | ---- | -------------------------- | ------------------------- |
      | 0.5 | 0.864985 +- 0.000789672|  0.818884 +- 0.000745897 | 
      | 0.25 | 0.384008 +- 0.002103 | 0.272267 +- 0.00117836 | 

      - Calculate with exact diagonalization.
        -lt : 2
          0, 1.24999478076359048724650389167005994993416419062970401654411e-15
          1, 0.000561178521508898090798533875300790896289981901645660400390625

        -lt : 1
          0, 3.73130874259994730714993376783848928992458712132831988306236e-16
          1, 0.0005611785215093203875447169792778367991559207439422607421875

        - I confirmed that they are equal

    

  - FF2D
    - This is for 2D frustration-free model.
    - Hamiltonian will be generated by specifying `-m FF2D`
    - PEPS is completely symmetric i.e. A_{ijklp} = A_{kjilp} = A_{ikljp} = A_{jklip} = ..
    - only sps higher than 7 had non-zero kernel 

    - sps = 8
    - loss u : "../python/rmsKit/array/torch/FF2D_loc/s_8_r_2_lt_1_d_2_seed_0/1_mel_Adam/lr_0.001_epoch_4000/loss_0.78790/u"

      | T | exact | none |  mel |
      | --- | ---- | ----| ---- |
      | 2 |  0.40849177318912683 | 0.407861 +- 0.00456863 |  0.408634 +- 0.00104305
      | 1 | 0.10993164025774552 | 0.109704 +- 0.00117202 |  
      ...
      | T    | mes                        | none                      |
      | ---- | -------------------------- | ------------------------- |
      | 2    | 0.944392 +- 0.000141849    | 0.218432 +- 0.00072113    |
