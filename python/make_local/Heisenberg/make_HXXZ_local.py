...
parser.add_argument(
    "-l", "--lattice", help="lattice (model) Name", required=True, choices=lattice
)
parser.add_argument(
    "-u",
    "--unitary_algorithm",
...
parser.add_argument(
    "-Jx", "--coupling_x", help="coupling constant (Jx)", type=float, default=1
)
parser.add_argument(
    "-Jy", "--coupling_y", help="coupling constant (Jy)", type=float, default=1
)
parser.add_argument(
    "-Hz", "--mag_z", help="magnetization in z direction", type=float, default=0
)  # + h * Sz
parser.add_argument(
    "-Hx", "--mag_x", help="magnetization in x direction", type=float, default=0
)  # + h * Sz
