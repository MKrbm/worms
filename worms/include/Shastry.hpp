...
namespace model{
  template <class MC>
  class Shastry :public base_spin_model<2,1,4,MC>{
public:
  typedef base_spin_model<2,1,4,MC> MDT; 
  ...
  template <class MC>
  class Shastry_2 :public base_spin_model<2, 2, 4, MC>{
public:
...
// for (auto path : {"../python/array/SS_ori_bond1.npy", "../python/array/SS_ori_bond2.npy"}) {
  ...
  int l = 2;
  loperators[local] = local_operator<MC>(l, 2); 
